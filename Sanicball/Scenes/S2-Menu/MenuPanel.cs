...
public partial class MenuPanel : ColorRect
{
    public override void _Ready()
    {
        ...
        GetNode<Button>("Content/Local").ButtonDown += () => tree.ChangeSceneToFile("res://Scenes/S3-Lobby/Lobby.tscn");
        GetNode<Button>("Content/Online").ButtonDown += () => tree.ChangeSceneToFile("res://Scenes/S3-Lobby/Lobby.tscn");
